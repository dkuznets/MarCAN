...
#define _s32 int
	...
	typedef struct {
		...
		_u32 ts;
	} canmsg_t, RX_TX_Buffer, *pRX_TX_Buffer;
...
#define DECLHEAD extern
	...
	// in new code use CiSetLom
	DECLHEAD _s16 CiSJA1000SetLom(_u8 chan);
	DECLHEAD _s16 CiSJA1000ClearLom(_u8 chan);
	// in new code use CiRcQueCancel CiRcQueResize, CiRcQueGetCnt, CiWriteTout
